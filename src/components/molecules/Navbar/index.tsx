const NavBar = () => {
  return (
    <div className="navbar bg-base-100">
      ...
      <button className="btn" onClick={()=>window.my_modal_1.showModal()}>Sign in</button>
          ...
          <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
            <div className="card-body">
              ...
              <div className="card-actions">
                <button className="btn btn-primary btn-block" onClick={()=>window.my_modal_1.showModal()}>View cart</button>
              </div>
            </div>
          </div>
        </div>
